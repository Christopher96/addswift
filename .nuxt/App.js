...
export default {
  head: {"titleTemplate":(titleChunk) => {
        ...
        },"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"A platform that enables everyday users to create their own global internet profile and connect with other people around the world."}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon\u002Ffavicon.ico"}],"style":[],"script":[]},
  render(h, props) {
